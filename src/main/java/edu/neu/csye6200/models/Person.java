...
public class Person {
	...
	public Person(int age, String name, String first_Name, String last_name, String date2, String gender,
			Vaccination[] immunization_Records2) {
		super();
		this.age = age;
		this.name = name;
		this.first_Name = first_Name;
		...
		setDate(date);
		this.gender = gender;
		this.immunization_Records = immunization_Records2;
	}
	public Person(int age, String name, String first_Name, String last_name, String date, String gender,
	...
	public void setDate(String date) {
		...
		String ourformat = formatter.format(date1);
		ourformat = Utils.addChar(ourformat, '/', 2);
		ourformat = Utils.addChar(ourformat, '/', 5);
		this.date = ourformat;
