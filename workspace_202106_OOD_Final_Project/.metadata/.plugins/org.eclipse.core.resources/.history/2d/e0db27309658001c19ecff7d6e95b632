...
public class Person {
	...
	private String immunization_Records;
	...
	public Person(int age, String name, String first_Name, String last_name, String date, String gender,
			String immunization_Records, EventRegistration eventRegistration) {
		super();
		this.age = age;
		this.name = name;
		this.first_Name = first_Name;
	...
	public String getImmunization_Records() {
		return immunization_Records;
	}
	public void setImmunization_Records(String immunization_Records) {
		this.immunization_Records = immunization_Records;
	}
	public int getAge() {
		return age;
